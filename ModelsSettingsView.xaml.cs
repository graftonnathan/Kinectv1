                ...
                try
                {
                    ...
                    if (svc != null)
                    {
                        ...
                        svc.Save(current =>
                        {
                            ...
                            return new Kinectv1.Settings.AppSettings(audio, tts, vadSettings, current.Ollama, current.Discord);
                        });
                    }
                }
        ...
        private void LocalVolumeSlider_ValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e)
        {
            try
            {
                ...
                svc?.Save(current =>
                {
                    ...
                    return new Kinectv1.Settings.AppSettings(current.Audio, tts, current.Vad, current.Ollama, current.Discord);
                });
            }
            catch (Exception ex)
            {
