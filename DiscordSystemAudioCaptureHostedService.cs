...
namespace Kinectv1
{
    ...
    public class DiscordSystemAudioCaptureHostedService : IHostedService
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                lock (_lock)
                {
                    ...
                    {
                        Console.WriteLine("⚠️ Discord System Audio Capture service failed to start");
                    }
                }
        ...
        public Task StopAsync(CancellationToken cancellationToken)
        {
            ...
            {
                Console.WriteLine($"⚠️ Error stopping Discord System Audio Capture service: {ex.Message}");
